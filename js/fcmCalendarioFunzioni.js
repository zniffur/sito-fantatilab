...
var d10
	...
	for (i=1;i<arr.length;i++) {
		...
		if (iCorrGiornataDiA != iPrecGiornataDiA) {
			...
			cale.SetStile(iCorrRiga,iCorrCol,"cale-gio")
			cale.SetValore(iCorrRiga,iCorrCol,"Giornata di A: " + iCorrGiornataDiA + " &nbsp;<a class='white' href='form.php?cGio=" + iCorrGiornataDiA + "'>Formazioni</a>&nbsp;" + "|&nbsp;<a class='white' href='ris.php?cGio=" + iCorrGiornataDiA + "'>Tabellini</a>")
		...
		//} // if iIncAcc == 1
 		if (iUltimoFormato == 0) {
			cale.SetStile(iCorrRiga,iCorrCol,"cale-inc-dispari")
			cale.SetStile(iCorrRiga,iCorrCol+1,"cale-ris-dispari")
			iUltimoFormato = 1
		} else {
			cale.SetStile(iCorrRiga,iCorrCol,"cale-inc-pari")
			cale.SetStile(iCorrRiga,iCorrCol+1,"cale-ris-pari")
			iUltimoFormato = 0
		}
