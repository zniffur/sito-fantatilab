...
document.write("<tr><td width='5%' class='testo-10'><nobr>&nbsp;&nbsp;Divisione:&nbsp;<select name='Div' class='testo-10' id='Div'>")
...
document.write("<td width='5%' class='testo-10'><nobr>&nbsp;&nbsp;Competizione:&nbsp;<select name='Comp' class='testo-10' id='Comp'>")
document.write("<option value='0'>- Tutte -</option>")
...
document.write("</select></nobr></td>")
document.write("<td width='90%' class='testo-10-bold'>&nbsp;&nbsp;<input name='Invia' type='submit' class='testo-10' id='Invia' value='  Vai  '></td>")
...
document.write("<td width='90%' class='testo-10'><nobr>&nbsp;&nbsp;<input name='Invia' type='submit' class='testo-10' id='Invia' value='  Vai  '></nobr></td>")
document.write("</tr></table></form><br>")
}
...
document.write("<table width='100%' border='00' cellspacing='0' cellpadding='0'>")
document.write("<tr><td width='5%' class='testo-10'><nobr>&nbsp;&nbsp;Giornata:&nbsp;<select name='Gio' class='testo-10' id='Gio'>")
for (i=1;i<=MaxA;i++) {
