...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>Fantacalcio - Formazioni</TITLE>
...
<TABLE width="100%" cellPadding=0 cellSpacing=0 class=f><TBODY>    <TR bgcolor="#FFFFFF">
            ...
            href="form.php">
            <H3>FORMAZIONI</H3>
            <P>Formazioni schierate per la prossima giornata</P>
            </A></DIV>
</TD></TR>
                             <TR>
                            <TD align=middle>
...
if (cDiv == null) cDiv = ""
if (cComp == null) cComp = ""
GeneraIntestazioneGiornateIncontri(cComp,cDiv,"form")



							if (cGio == null) cGio =GetProssimaGiornataDaGiocare();

							if (cComp == null) cComp = ""

							if (cGio=="") cGio=GetProssimaGiornataDaGiocare();

								GeneraFormazioni(cGio,cComp)
