...
document.write("<div><div style='margin:6px; float:left; width: 30%; text-align:left; height:120px;'>&nbsp;&nbsp;&nbsp;<img src='img/fsq/" + arrFantasquadre[i].Nome + ".png'></div>")
document.write("<div style='margin:6px; float:right; width: 60%; height:120px;text-align:right;'>")
	...
	tabS.SetValore(isDivisione+8,1,"&nbsp;<div style='text-align:center'><img src='img/fsq/" + arrFantasquadre[i].Nome + ".gif'></div>")
...
tabR.SetValore(cnt,1,"<div style='float:left; width:65%;' class='t-xxs"+sR+"'>&nbsp;"+ toProperCase(filterSpecial(filter(arrRose[i].Nome)))+"</div><div style='float:left; width:34.9%;' class='t-xxs"+sR+"'>&nbsp;"+ arrRose[i].Squadra+"</div>")
		//	tabR.SetValore(cnt,2,"<span class='t-xxs"+sR+"'>&nbsp;"+ arrRose[i].Squadra+"</span>")
		//	tabR.SetValore(cnt,3,"<span class='t-xxs"+sR+"'>"+(arrRose[i].Contratto==-2?"Pres":arrRose[i].Contratto)+"</span>")
		//	tabR.SetValore(cnt,4,"<span class='t-xxs"+sR+"'>"+arrRose[i].Acq+"</span>")
			cnt++
		} else {
...
var i,cnt,sT,sR,fatto
	...
	for(i=1;i<arrRose.length;i++) {
		if ((arrRose[i].IDSquadra==IDSquadra)&&(arrRose[i].Stato==1)) {
			...
			tabV.SetValore(cnt,2,"<span class='t-xxs"+sR+"'>&nbsp;"+arrRose[i].Nome+"</span>")
			...
			tabV.SetValore(cnt,5,"<span class='t-xxs"+sR+"'>"+arrRose[i].Acq+"</span>")
			cnt++
		} else {
			if ((fatto) && (arrRose[i].IDSquadra!=IDSquadra)) i=arrRose.length
			//esce dal ciclo senza proseguire per tutte le altre
...
var i,cnt,sT,sR,fatto
	...
	for(i=1;i<arrBilanci.length;i++) {
		if (arrBilanci[i].IDSquadra==IDSquadra) {
			...
			tabB.SetValore(cnt,2,arrBilanci[i].Valore>=0?"<span class='t-xxsBluB'>"+arrBilanci[i].Valore+"</span>":"")
